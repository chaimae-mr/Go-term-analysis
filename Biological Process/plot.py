...
def calculate(i,j,heatmap_colors,heatmap_size):
    file = ['Go_analysis_5_P.csv','Go_analysis_6_P.csv','Go_analysis_7_P.csv','Go_analysis_8_P.csv','Go_analysis_9_P.csv','Go_analysis_10_P.csv']
...
def histo():
	...
	fig = plt.gcf()
	plt.title("Biological Process",size=20,color='brown')
	fig.set_size_inches(20, 20)
	plt.xlabel("Frequancy",size=15)
