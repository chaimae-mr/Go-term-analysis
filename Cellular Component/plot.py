...
def calculate(i,j,heatmap_colors,heatmap_size):
    file = ['Go_analysis_5_C.csv','Go_analysis_6_C.csv','Go_analysis_7_C.csv','Go_analysis_8_C.csv','Go_analysis_9_C.csv','Go_analysis_10_C.csv']
...
def histo():
	...
	fig = plt.gcf()
	plt.title("Cellular Component",size=20,color='brown')
