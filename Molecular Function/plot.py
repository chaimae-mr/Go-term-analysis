...
def calculate(i,j,heatmap_colors,heatmap_size):
    file = ['Go_analysis_5_F.csv','Go_analysis_6_F.csv','Go_analysis_7_F.csv','Go_analysis_8_F.csv','Go_analysis_9_F.csv','Go_analysis_10_F.csv']
...
def histo():
	...
	fig = plt.gcf()
	plt.title("Molecular Function",size=20,color='brown')
